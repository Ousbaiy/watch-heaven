...
const Cancel = () => {
  return (
    <div className="pt-40 lg:pt-0 h-[600px] flex items-center justify-center text-center ">
      <div className="container mx-auto grad dark:grad-dark w-[350px] lg:w-[500px] h-[350px] lg:h-[500px] rounded-md flex flex-col justify-center items-center gap-y-5 p-2 lg:p-10 ">
