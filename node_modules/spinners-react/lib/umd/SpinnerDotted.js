(function (global, factory) {
    ...
    ***************************************************************************** */
    ...
    __assign(__assign({}, defaultProps$1), { secondaryColor: 'rgba(0,0,0,0.44)' });
    ...
    var Component = function (_a) {
        ...
        return (React__default["default"].createElement("svg", __assign({ fill: "none", viewBox: "0 0 66 66" }, svgProps),
            coords.map(function (c, i) { return (React__default["default"].createElement("circle", { key: c.x + "-" + c.y, cx: "33", cy: "33", fill: "currentColor", r: 3 * (thickness / 100), style: __assign({ transform: "translate(" + c.x + "px, " + c.y + "px)" }, generateCircleStyle(i)) })); }),
    ...
    var SpinnerDotted = withSharedProps(Component);

    exports.Component = Component;
    exports.SpinnerDotted = SpinnerDotted;

}));
//# sourceMappingURL=SpinnerDotted.js.map
